package ru.fizteh.fivt.students.sergeymelikov.storeable.junit;
...
import ru.fizteh.fivt.students.sergeymelikov.shell.CommandRemove;
import ru.fizteh.fivt.students.sergeymelikov.storeable.MyStoreable;
import ru.fizteh.fivt.students.sergeymelikov.storeable.MyTableProvider;
...
import ru.fizteh.fivt.students.sergeymelikov.utils.Serializer;
...
public class XMLSerializerTest {
    ...
    private static final String DATA_BASE_DIR = "./src/ru/fizteh/fivt/students/sergeymelikov/test";
    ...
    public void correctDeserialize() throws Exception {
        Storeable s = Serializer.deserialize(table, desirialized);
    ...
    public void incorrectDeserialize() throws Exception {
        Serializer.deserialize(table, "<row>fvdfv");
    }
    
    @Test (expected = ParseException.class)
    public void incorrectTypeDeserialize() throws Exception {
        Serializer.deserialize(table, "<row><col>Hello</col><col>jghd</col></row>");
    }
    ...
    public void correctSerialize() throws Exception {
        ...
        s.setColumnAt(1, 5);
        String res = Serializer.serialize(table, s);
